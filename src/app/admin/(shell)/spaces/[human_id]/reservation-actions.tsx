...
const TEMPLATE_OPTIONS: {
  ...
  },
  {
    value: "approve",
    label: "Approval",
    description: "Confirms the booking and shares load-in details.",
  },
  {
    value: "deny",
    label: "Denial",
  ...
  },
  {
    ...
    description: "Sent after the event — thanks the organizer, invites feedback.",
  },
];
...
function EmailComposeModal({
  ...
  async function handleSend() {
    ...
    setStage({ kind: "sent", template, subject: result.subject });
  }
          ...
          {stage.kind === "pick" && (
            <div>
              <p className="mb-3 text-sm text-neutral-600">
                Pick a template. You&apos;ll see the draft before it sends and
                can edit anything.
              </p>
                ...
                <div className="mt-4">
                  <label className="block text-sm">
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder="e.g. Space is already committed that day."
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-neutral-500">
                  Plain text. Blank lines become paragraph breaks; URLs
                  auto-link.
                </p>
              </div>
            </div>
